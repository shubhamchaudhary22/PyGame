...
pygame.display.set_icon(icon)    #32*32
...
def game_intro():
    ...
    while intro:
        ...
        message_to_screen("Welcome to Snakes",
                          green,
                          -100,
                          "large")
...
def gameLoop():
    ...
    lead_y_change = 0
    appleThickness = 30
    randAppleX = random.randrange(0, (display_width-appleThickness))#/10)*10
    randAppleY = random.randrange(0, (display_height-appleThickness))#/10)*10
    while not gameExit:
